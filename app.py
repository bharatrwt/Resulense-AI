...
# Log in the user and increment login count
def login_user(email: str, password: str):
    ...
    if user and verify_password(user[0], password):
        # User is authenticated, update the login count
        new_count = user[1] + 1
        cursor.execute('''
            UPDATE users SET login_count = ? WHERE email = ?
        ''', (new_count, email))
        conn.commit()
        st.session_state["logged_in"] = True
        st.session_state["email"] = email
        st.session_state["login_count"] = new_count
        st.success(f"Login successful! {email} has logged in {new_count} times.")
    else:
        st.error("Incorrect email or password.")

# Streamlit sign-in form
def sign_in():
    st.title("Sign In to Resulense AI")
...
class ResumeApp:
    ...
    def render_about(self):
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Resulense AI</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <p class="bio-text">
                    ...
                    I created Resulense AI (An Smart Resume AI) to revolutionize how job seekers approach their career journey. 
    ...
    def render_home(self):
        ...
        # Hero Section
        hero_section(
            "RESULENSE AI (An Smart-AI-Resume Analyzer)",
